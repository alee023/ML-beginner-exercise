...
data_transforms = transforms.Compose([ transforms.ToTensor(), transforms.Resize((224, 224)), transforms.Normalize((0.1397,),(0.3081,)), target_transform = transforms.Lambda( lambda x: 0 if ( x.targets == 3 ) else 1 )]) 
